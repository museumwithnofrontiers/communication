...
<template>
  <SiteShell
    v-bind="$attrs"
    header-home="#/"
    :footer-text="t('communication.identity.copyright')"
  >
    <template #brand>
      <span class="site-logo">
        <span class="site-logo-org">{{ t('communication.identity.organisation') }}</span>
        <span class="site-logo-title">{{ t('communication.identity.title') }}</span>
      </span>
    </template>
    <slot />
  </SiteShell>
