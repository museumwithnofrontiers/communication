...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'communication',
  ...
  home: {
    title: 'communication.identity.title',
    intro: 'communication.home.intro',
    cards: [
      {
        title: 'communication.nav.catalogue',
        description: 'communication.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'communication.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'communication.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'communication.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //       partnerObjects: {
  //         emptyPartner: 'communication.partnerObjects.emptyPartner',
  //         emptyInstitution: 'communication.partnerObjects.emptyInstitution',
  //         institutionSummary: 'communication.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'communication.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'communication.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
